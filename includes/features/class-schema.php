...
class Schema {
	 ...
	 */
	private static $statistics = HSISS_SLUG . '_statistics';
	...
	public static function init() {
		add_action( 'shutdown', [ 'Hsiss\Plugin\Feature\Schema', 'write' ], 90, 0 );
